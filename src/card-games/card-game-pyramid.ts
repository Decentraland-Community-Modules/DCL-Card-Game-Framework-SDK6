/*      PYRAMID SOLITAIRE CARD GAME MANAGER
    represents the logic/game rules of the game of solitaire, pyramid style. 
...
export class CardGameManagerSolitairePyramid extends CardGameManager
{
    //constructor
    ...
    public Initialize()
    {
        ...
        this.resources.SetRequiredCollections(3, 7, false);
        for (let i = 0; i < 7; i++) 
        {
            //set object position details
            this.cardObjectManager.SetGroupObjectPosition(3, i, 0, new Vector3(-((i*0.40)/2), 0.05, 1.30-(i*0.4)));
            this.cardObjectManager.SetGroupCardPosition(3, i, 0, new Vector3(0, (0.001*i)+0.01, 0));
            this.cardObjectManager.SetGroupCardPosition(3, i, 1, new Vector3(0.40, 0.0, 0));
        }
